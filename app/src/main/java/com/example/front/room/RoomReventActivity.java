...
public class RoomReventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_revent);
        Button btnBack = findViewById(R.id.btn_room_revent_back);
        Button btnDone = findViewById(R.id.btn_room_revent_done);

        recyclerView = findViewById(R.id.rv_room_revent);
